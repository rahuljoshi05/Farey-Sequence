...
namespace TestFareySeq
{
    class FareySeqAlgo
    {
        public string getFareySeqForNumber(int orderNum)
        {
            string result = "";
            ...
            try
            {
                ...
                double x1 = 0, y1 = 1, x2 = 1, y2 = orderNum;
                result = result + x1 + "/" + y1;
                result = result+", " + x2 + "/" + y2;
                ...
                while (tempY != 1.0)
                {
                    ...
                    tempX = Math.Floor((y1 + orderNum) / y2) * x2 - x1;
                    tempY = Math.Floor((y1 + orderNum) / y2) * y2 - y1;
                    //Capture result
